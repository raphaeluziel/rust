...
/// Given the row and column of a pixel in the output image, return the corresponding point on the corresponding point on the complex plane.
/// 
/// 'bounds' is a pair giving the width and height of the image in pixels.
/// 'pixel' is a (column, row) pair indicating a particular pixel in that image.
/// The 'upper_left' and 'lower_right' parameters on the complex plane designating the area the image covers
fn pixel_to_point(bounds: (usize, usize),
    ...
    -> Complex<f64> 
    {
        ...
        Complex {
            ...
            // Why subtraction here? ixel.1 increases as we go down,
